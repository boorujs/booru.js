...
bright and so on according to the [Levenshtein distance].
...
In general, combining the same metatags (the ones that have colons in them) will
not work.
...
Find images with a width greater than or equal to 1000 and a height greater than
1000.

**score:>=10**  
Find images with a score greater than or equal to 10. This value is updated once
daily at 12AM CST.
